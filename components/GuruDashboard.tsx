  ...
  const renderContent = () => {
    ...
    return (
       <div className="space-y-4">
          {exams.map(exam => (
            <div key={exam.id} className="bg-slate-700/50 p-4 rounded-lg flex justify-between items-center transition-all hover:bg-slate-700">
              <div>
              ...
              <div className="flex space-x-2">
                <button className="text-sm px-3 py-1 bg-slate-600 rounded hover:bg-slate-500 transition-colors">Edit</button>
                <button className="text-sm px-3 py-1 bg-blue-600 rounded hover:bg-blue-500 transition-colors">Lihat Hasil</button>
                 <button className="text-sm px-3 py-1 bg-red-600 rounded hover:bg-red-500 transition-colors">Hapus</button>
              </div>
            </div>
          ))}
        </div>
